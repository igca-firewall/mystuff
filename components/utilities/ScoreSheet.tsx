          ...
          <table className="min-w-full table-auto border-collapse bg-white dark:bg-neutral-800 rounded-lg shadow-md overflow-hidden">
            ...
            <tbody>
              {students.map((student, index) => {
                const studentResult = scores.find(
...
//           const result = await fetchResultWithSubject({
//             classRoom,
//             term,
//             subject,
//             session,
...
//               const matchingScore = result.find(
//                 (res) => res.studentId === student.studentId
//               );
//               return {
//                 studentId: student.studentId,
//                 score: matchingScore ? matchingScore.score : "", // Default to empty if no score available
//               };
//             });

//             setStudentsScores(studentsWithScores);
//           } else {
