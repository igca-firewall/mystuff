...
//   }, []);
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const allStudents = await listAllStudents(); // Replace with your actual API call
    ...
    datasets: [
      {
        ...
        data: students.map(
          (s) =>
            new Date().getFullYear() - new Date(s.dateOfBirth).getFullYear()
        ),
        fill: false,
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <table className="min-w-full table-auto border-collapse border border-gray-200">
            <thead className="bg-purple-100">
              <tr>
                <th className="px-4 py-2 border border-gray-200 text-purple-900">
                  Name
                </th>
                <th className="px-4 py-2 border border-gray-200 text-purple-900">
                  Class
